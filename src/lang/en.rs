...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the KinBridge network..."),
        ...
        ("install_tip", "Due to UAC, KinBridge can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install KinBridge to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant KinBridge \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant KinBridge \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow KinBridge to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [KinBridge Input] service."),
        ...
        ("doc_mac_permission", "https://kinbridge.support/help/mac#permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next KinBridge application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant KinBridge \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant KinBridge \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running KinBridge."),
        ...
        ("verify_rustdesk_password_tip", "Verify KinBridge password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use KinBridge and start the service, do not proceed and hang up immediately."),
        ...
        ("doc_fix_wayland", "https://kinbridge.support/help/linux#x11"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent KinBridge from running properly as controlled side."),
        ...
        // AGPL attribution — the "Powered by RustDesk" string is what credits
        // the upstream project. Must keep "RustDesk" here; do not retranslate.
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if KinBridge window is open"),
        ...
        ("floating_window_tip", "It helps to keep KinBridge background service"),
        ...
        // Dart UI looks this key up as "About RustDesk" (original upstream
        // string); we keep the key stable so sync-from-upstream doesn't break,
        // and only override the display value.
        ("About RustDesk", "About KinBridge Support"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the KinBridge client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, KinBridge verifies the server certificate for protocols using TLS.\nWith this option enabled, KinBridge will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, KinBridge will not use UDP 21116 any more, TCP 21116 will be used instead."),
