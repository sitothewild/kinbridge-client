...
import 'package:kinbridge_support/common/widgets/overlay.dart';
import 'package:kinbridge_support/desktop/pages/desktop_tab_page.dart';
import 'package:kinbridge_support/desktop/pages/install_page.dart';
import 'package:kinbridge_support/desktop/pages/server_page.dart';
import 'package:kinbridge_support/desktop/screen/desktop_file_transfer_screen.dart';
import 'package:kinbridge_support/desktop/screen/desktop_view_camera_screen.dart';
import 'package:kinbridge_support/desktop/screen/desktop_port_forward_screen.dart';
import 'package:kinbridge_support/desktop/screen/desktop_remote_screen.dart';
import 'package:kinbridge_support/desktop/screen/desktop_terminal_screen.dart';
...
import 'package:kinbridge_support/plugin/handlers.dart'
    if (dart.library.html) 'package:kinbridge_support/web/plugin/handlers.dart';
...
void runMainApp(bool startService) async {
  ...
  windowManager.waitUntilReadyToShow(windowOptions, () async {
    ...
    if (handledByUniLinks || handleUriLink(cmdArgs: kBootArgs)) {
      ...
      kbWinManager.registerActiveWindow(kWindowMainId);
    }
