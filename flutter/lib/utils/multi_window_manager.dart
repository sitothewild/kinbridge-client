...
class KBMultiWindowManager {
  KBMultiWindowManager._();

  static final instance = KBMultiWindowManager._();
  ...
  /// `kbWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final kbWinManager = KBMultiWindowManager.instance;
