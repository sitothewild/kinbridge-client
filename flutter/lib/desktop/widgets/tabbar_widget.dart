...
import 'package:kinbridge_support/desktop/pages/remote_page.dart';
import 'package:kinbridge_support/desktop/pages/view_camera_page.dart';
...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (kbWinManager.getActiveWindows().contains(kMainWindowId)) {
        await kbWinManager.unregisterActiveWindow(kMainWindowId);
      }
