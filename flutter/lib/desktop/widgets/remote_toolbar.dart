...
import 'package:kinbridge_support/common/widgets/toolbar.dart';
...
import 'package:kinbridge_support/plugin/common.dart';
...
import 'package:kinbridge_support/common/widgets/custom_scale_base.dart';
...
class ScreenAdjustor {
  ...
  _getScreenInfoDesktop() async {
    final v = await kbWinManager.call(
